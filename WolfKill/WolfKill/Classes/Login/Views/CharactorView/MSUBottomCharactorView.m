...
@implementation MSUBottomCharactorView
...
- (void)createView{
    ...
    [_charactBtn makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(self.left).offset(characWidth);
    ...
    [_wolfIma makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(_charactBtn.left).offset(-25);
    ...
    [_cupidIma makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.equalTo(_roomOwnerIma.top).offset(1);
